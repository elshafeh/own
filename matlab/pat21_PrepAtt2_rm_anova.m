function stats = PrepAtt2_rm_anova(Y,S,F1,F2,FACTNAMES)
%
% function stats = rm_anova2(Y,S,F1,F2,FACTNAMES)
%
% Two-factor, within-subject repeated measures ANOVA.  (sphericity assumed)
...
% AnneC : change avant arrivee stat toolbox
% pA=0;
% pB=0;
% pAB=0;
