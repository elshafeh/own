function [vol, grid] = new_exemple_script_headmodel_normalized(mri_filename, headshape_leadfield_backup_filename)
...
path_ft = '/dycog/Aurelie/DATA/MEG/fieldtrip-20151124/';
...
if nargin == 2
    ...
    template = ft_read_mri([path_ft, '/template/anatomy/single_subj_T1_1mm.nii']);
    ...
    save('/dycog/Aurelie/DATA/MEG/PAT_MEG/pat.field/data/template/template_grid.mat','template_grid'); % !! this where you save your template grid !!!!
