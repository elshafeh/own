    ...
    for nband = 1:length(list_band)
        for nlock = 1:length(list_lock)
            ...
            for nfreq = 1:length(list_freq)
                ...
                fin_ext             = '.bsl.dwn70.excl.auc.mat';
                
                                
                file_list         	= dir([dir_data suj_name '.sess*.1back.' num2str(list_freq(nfreq)) 'Hz.' list_lock{nlock} fin_ext]);
                file_list         	= [file_list; dir([dir_data suj_name '.sess*.2back.' num2str(list_freq(nfreq)) 'Hz.' list_lock{nlock} fin_ext])];
