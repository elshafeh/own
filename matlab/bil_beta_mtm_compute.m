function freq_comb = bil_beta_mtm_compute(subjectName)
...
chk                     = [];dir(['/project/3015039.06/bil/tf/' subjectName '.*firstcuelock.14t35Hz.1HzStep.KeepTrials.comb.mat']);
...
if isempty(chk)
    ...
    %     catch
    dir_data        = '/project/3015039.06/bil/tf/';
    fname               = [dir_data subjectName '.' ext_name '.mat'];
    fprintf('\nagain.. Saving %s\n',fname);
    save(fname,'freq_comb','-v7.3');
    %     end
