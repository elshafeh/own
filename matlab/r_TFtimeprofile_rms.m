function r_TFtimeprofile_rms(event,cond,fwin,blwin,list_ctl,list_mig)
...
for sb = 1:length(list_suj)
    ...
    epfileIN  = ['../data/' list_suj{sb} '/tf/' event '/' list_suj{sb} '.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.lb'];
...
epfileOUT   = ['../data/avg_mig/tf/' event '/ctl.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.lb.gfp'];
system(['rm ' epfileOUT '.p'])
...
for sb = 1:length(list_ctl)
    ...
    epfileIN = ['../data/' list_ctl{sb} '/tf/' event '/' list_ctl{sb} '.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.lb.gfp'];
    fprintf(fid,'%s\n',epfileIN)
...
epfileOUT   = ['../data/avg_mig/tf/' event '/mig.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.lb.gfp'];
system(['rm ' epfileOUT '.p'])
...
for sb = 1:length(list_mig)
    ...
    epfileIN = ['../data/' list_mig{sb} '/tf/' event '/' list_mig{sb} '.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.lb.gfp'];
    fprintf(fid,'%s\n',epfileIN);
...
epfileOUT   = ['../data/avg_mig/tf/' event '/ctl.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.median.lb.gfp'];
system(['rm ' epfileOUT '.p'])
...
epfileOUT   = ['../data/avg_mig/tf/' event '/mig.pat22.' cond '.freq' num2str(fwin(1)) '-' num2str(fwin(2)) '.median.lb.gfp'];
system(['rm ' epfileOUT '.p'])
