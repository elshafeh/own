...
for nsuj = 1:length(suj_list)
    ...
    for nbehav = 1:2
        ...
        for nback = 1:2
            ...
            if length(check_file) == 1
                ...
                nb_count            = nb_count+1;
                pow(nb_count,:,:,:)	= freq_comb.powspctrm;
    ...
    for nband = [1 2]
        ...
        for nbehav = [1 2]
            ...
            avg.avg       	= squeeze(sub_pow(nbehav,:,:));
