...
for ns = 1:length(suj_list)
    ...
    list_cond                               = {'pre.vs.retro','retro.ori.vs.spa','pre.ori.vs.spa'};
    ...
    for ncond = 1:length(list_cond)
        ...
        for nfreq = 1:length(freq_list)
            ...
            fname                               = ['J:/temp/bil/cue_mtm_auc/' subjectName '.decodecue.' list_cond{ncond} '.' ...
...
list_cond                                       = {'pre.vs.retro','retro.ori.vs.spa','pre.ori.vs.spa','chance'};
