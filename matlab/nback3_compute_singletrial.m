...
for nsuj = [1:33 35:36 38:44 46:51]
    ...
    fname_out               = [dir_data 'sub' num2str(nsuj) '.singletrial.trialinfo.mat'];
    ...
    dir_data                = '~/Dropbox/project_me/data/nback/singletrial/';
    fname_out               = [dir_data 'sub' num2str(nsuj) '.singletrial.erfComb.mat'];
    ...
    for ntime = 1:length(list_time_name)
        ...
        dir_data        	= '~/Dropbox/project_me/data/nback/singletrial/';
        fname_out           = [dir_data 'sub' num2str(nsuj) '.singletrial.fft.mat'];
    ...
    dir_data                = '~/Dropbox/project_me/data/nback/singletrial/';
    fname_out               = [dir_data 'sub' num2str(nsuj) '.singletrial.mtm.mat'];
