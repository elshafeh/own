...
for nsuj = 1:length(suj_list)
    ...
    for nback = [0 1 2]
        ...
        check_name                              = dir(['J:/temp/nback/data/tf_sens/' subjectName '.sess*.' num2str(nback) 'back.mtmconvolPOW.m1.5p2s.20msStep.1t7Hz.1HzStep.AvgTrials.sens.mat']);
        ...
        xi                                      = find(round(freq.freq) == round(4));
        yi                                      = find(round(freq.freq) == round(6));
...
for n = 1
    ...
    list_chan                       = {'MEG1832+1833', 'MEG2012+2013', 'MEG2022+2023', ...
