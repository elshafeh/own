            ...
            for nfreq = 1:size(stat,4)
                if min_p(ngroup,ntest,ntime,nfreq) < p_limit
                    ...
                    for iside = [1 2]
                        ...
                        dir_data     = '~/Dropbox/project_me/pub/Papers/ageing_alpha_and_gamma/plosOne2019/_rev_figures/';
                        saveas(gca,[dir_data 'gamma-infunf' num2str(ngroup) '-'  num2str(iside) '.png']);
