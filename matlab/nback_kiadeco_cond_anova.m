...
for nsuj = 1:length(suj_list)
    ...
    for nfreq = 1:length(list_freq)
        for nlock = 1:length(list_lock)
            ...
            fname               	= ['J:/nback/kia/sub' num2str(suj_list(nsuj)) '.kiadecoding.1backor2back.' num2str(list_freq(nfreq)) 'Hz'];
    ...
    keep alldata nsuj suj_list allpeaks list_cond
