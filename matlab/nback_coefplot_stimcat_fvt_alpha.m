...
for nsuj  = 1:length(list_suj)
    ...
    list_cond                                   = {'alpha.peak.centered.1back.isfirst','alpha.peak.centered.2back.isfirst', ...
        'alpha.peak.centered.1back.istarget','alpha.peak.centered.2back.istarget'};
...
load ../data/stat/nback_stim_category_first_v_target_alpha.mat

%%
close all
zlist                       = [0.005 0.005 0.005];
list_test                   = [3 1; 4 1; 4 2];
cluster_list                = {[1]};
