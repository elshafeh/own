...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [MI_matrix_raw,MI_matrix_surr,MI_raw_surr] = separate_calc_MI(suj,original_virtsens_pha,original_virtsens_amp,toi,phase,amp,diag,surrogates,approach,step_phase,step_amp,varargin)
...
for han_phase_i = 1:iphase
    for han_ampl_i = 1:iampl
        ...
        % For each trial...
        for trial_num = 1:length(original_virtsens_amp.trial)
