function  [med_rt,mean_rt,perc_corr,ntrial,strial_rt] = h_behav_exclude(suj,list_cue,list_dis,list_tar,rt_limit)
...
clearvars -except behav_summary suj list_* rt_limit

behav_summary(:,22) = 1;

for ntrl = 1:length(behav_summary)-1
    
    rt      = behav_summary(ntrl,11);
    
    if rt >= rt_limit
        behav_summary(ntrl+1,22) = -1;
    end
    
end

behav_table                     = array2table(behav_summary,'VariableNames',{'sub_idx' ;'nbloc'; 'ntrl_blc'; 'code'; 'CUE' ;'DIS';'TAR'; 'XP' ;'REP';'CORR' ; ...
    'RT' ;'ERROR' ;'cue_idx'; 'CT' ;'DT' ;'cueON';'disON';'tarON';'CLASS';'idx_group'; 'CD'; 'FREE'});
...
final_behav             = subset_behav(subset_behav.ERROR ==0 & subset_behav.CORR==1 & subset_behav.FREE ==1,:);
