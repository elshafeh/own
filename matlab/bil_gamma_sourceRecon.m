...
for nsuj = 1:length(suj_list)
    ...
    for nf = 1:length(list_freq)
        ...
        pkg_source(1).time_win                          = [-0.3 -0.1;0.1 0.3; 4.9 5.2];
        pkg_source(1).pad_lim                           = 0.5;
        ...
        pkg_source(2).time_win                          = [-0.4 -0.1; 0.1 0.4; 1.2 1.5];
        pkg_source(1).pad_lim                           = 0.5;
        ...
        pkg_source(3).time_win                          = [-0.5 -0.1; 3.4 3.8];
        pkg_source(3).pad_lim                           = 0.5;
