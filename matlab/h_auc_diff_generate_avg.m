function [data] = h_auc_diff_generate_avg(sujname,list_stim,flg_trials,list_time)
...
for nstim = 1:length(list_stim)
    ...
    try
        ...
        t1              = nearest(time_axis,list_time(1));
        t2              = nearest(time_axis,list_time(2));
        
        y_array        	= y_array(flg_trials,t1:t2);
        yproba_array   	= yproba_array(flg_trials,t1:t2);
