function mat2tf_intra(tf_file_name, s_type_tfmoy, s_type_1_tfmoy, s_type_2_tfmoy, s_type_signal,m_Data_TF, v_Elec, ...
    v_Channels_Label, s_Nb_Sample_PreStim, s_Sampling_Frequency, s_Wavelet_Type, v_Frequency_Bins, v_Wavelet_m_parameter,  ...
    s_Blackman_Window_Size, s_DownSampling_Step, v_Nb_Evt_per_Chan, s_corr_BL, s_smooth_tf, s_Avg_Chan)
