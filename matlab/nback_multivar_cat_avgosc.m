    ...
    for nlock = 1:length(list_lock)
        for nback = 1:length(list_nback)
            ...
            for nfreq = 1:length(list_freq)
                ...
                file_list         	= dir(['J:/nback/sens_level_auc/cond/sub' num2str(suj_list(nsuj)) '.sess*.' list_nback{nback} '.' num2str(list_freq(nfreq)) 'Hz.'  list_lock{nlock} '.bsl.dwn70.excl.auc.mat']);
