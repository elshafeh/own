...
for nsuj = 1:length(suj_list)
    ...
    for ncond = 1:2
        ...
        %         fname_list              	= dir(['J:/temp/nback/data/sens_level_auc/cond/sub'  num2str(suj_list(nsuj)) '.sess' num2str(ncond) '.decoding.' ...
        %                 num2str(ncond-1) 'back.lockedon.all.dwn70.bsl.excl.auc.mat']);
        
        fname_list              	= dir(['J:/temp/nback/data/sens_level_auc/cond/sub' num2str(suj_list(nsuj)) '.decoding.*' ...
                '.agaisnt.all.lockedon.target.dwn70.bsl.excl.auc.mat']);
