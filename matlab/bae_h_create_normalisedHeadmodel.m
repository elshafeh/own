function [vol, grid] = h_create_normalisedHeadmodel(mri_filename, headshape_leadfield_backup_filename,vox_size)
...
if ~isempty(headshape_leadfield_backup_filename)
    ...
    template = ft_read_mri('/mnt/autofs/Aurelie/DATA/MEG/fieldtrip-20151124/template/anatomy/single_subj_T1_1mm.nii');
    ...
    save(['/mnt/autofs/Aurelie/DATA/MEG/PAT_EXPE22/data_fieldtrip/template/template_grid_' num2str(vox_size) 'cm.mat'],'template_grid');
