...
for ngroup = 1:length(suj_group)
    ...
    for sb = 1:length(suj_list)
        ...
        for ncue = 1:length(list_ix_cue)
            ...
            ext_mat             = 'waveletPOW.40t150Hz.m1000p1000.10Mstep.AvgTrials.MinEvoked.mat';
            
            suj                 = suj_list{sb};
            fname_in            = ['../data/' suj '/field/' suj '.' list_ix_cue{ncue} 'DIS.' ext_mat];
            ...
            fname_in            = ['../data/' suj '/field/' suj '.' list_ix_cue{ncue} 'fDIS.' ext_mat];
