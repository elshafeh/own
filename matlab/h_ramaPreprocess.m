function [dataica,avg]      = h_ramaPreprocess(data_elan,cov_window,latency_select)

% [ext_essai,dataica,avg]     = h_ramaPreprocess(data_elan,bp_list,cov_window,latency_select,suj,ext_lock)
