function PrepAtt2_fun_eeg2field_target(suj,time_pre,time_post)

elan_file   = ['/Volumes/PAT_MEG2/Fieldtripping/data/eeg/' suj '.pat2.fin.eeg.eeg'];
pos_orig    = load(['/Volumes/PAT_MEG2/Fieldtripping/data/pos/' suj '.pat2.fin.pos']);
...
dir_field     =    ['/Volumes/PAT_MEG/Fieldtripping/data/' suj '/'];
...
for cond = {''}
    ...
    mat_name_out=[dir_mat suj '.' cond{:} 'DT.eeg.mat'];
