function com_filter = h_prep21_common_filter(data_elan,leadfield,vol,name_in,name_extra,freq_foi,freq_tap)
...
% save(FnameFilterOut,'com_filter','-v7.3');