    ...
    for nband = 1:length(list_band)
        for nback = 1:length(list_nback)
            ...
            for nfreq = 1:length(list_freq)
                ...
                file_list        	= dir(['J:/nback/sens_level_auc/kia/sub' num2str(suj_list(nsuj)) '.sess*.' list_nback{nback} ...
                    '.' num2str(list_freq(nfreq)) 'Hz.lockedon.target.decoding.stim*.agaisnt.all.bsl.excl.auc.mat']);
