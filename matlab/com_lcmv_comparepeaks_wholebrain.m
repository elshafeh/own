...
for nsuj = 1:length(suj_list)
    ...
    for ndata = 1:2
        ...
        fname_in                    = ['../data/peaks/' suj '.CnD.brain.slct.bp.' data_list{ndata} '.m1000m0ms.alphapeak.mat'];
        fprintf('Loading %50s\n',fname_in);
        load(fname_in);
        
        mtrx                      	= allpeaks(:,2);
        source                      = h_towholebrain(mtrx,'../data/template/com_btomeroi_select.mat','../data/template/template_grid_5mm.mat');
