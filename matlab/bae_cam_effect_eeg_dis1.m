...
suj_group{1}        = suj_group{1}([2:9 11 13:22]);
...
for ngroup = 1:size(stat,1)
    for ntest = 4 %1:size(stat,2)
        for nchan = 2 %1:size(stat,3)
...
save 'cluster_based_permutations_young_dis1_eeg_channels.mat'