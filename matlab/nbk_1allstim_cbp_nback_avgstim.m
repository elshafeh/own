...
for ns = 1:length(suj_list)
    ...
    for nback = [1 2 3]
        ...
        list_chan                       = {};
        list_lock                       = {'1st stim lock','2nd stim lock','3rd stim lock'};
        ...
        for nlock = [1 2 3]
            ...
            for nstim = 1:10
                ...
                fname                   = ['../data/decode_data/stim_stack/sub' num2str(suj_list(ns)) '.stim' num2str(nstim) '.' num2str(nback-1) 'back.' num2str(nlock-1) 'lock.auc.collapse.mat'];
            ...
            data(nlock,:)               = mean(tmp,1); clear tmp;
    ...
    if min_p(nt) < p_limit
        ...
        for nchan = 1:length(stat{nt}.label)
            ...
            if ~isempty(ix)
                ...
                list_name_stat      = {'0 v 1 Back','0 v 2 Back','1 v 2 Back'};
