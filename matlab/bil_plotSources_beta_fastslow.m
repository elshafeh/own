...
for nsuj = 1:length(suj_list)
    ...
    list_window                             = {'p3700p5300' 'p5200p6500'};
    list_bsl                                = {'m1200m200' 'm1200m200'};
...
list_colormap                               = {'*Blues' 'Reds'};
list_zlim                                   = [-0.06 0; 0 0.25];
...
for ntime = 1:size(alldata,2)
    for nview = [1 2 3]
        ...
        saveas(gcf,[dir_fig 'beta.fast.slow.conrast.' list_window{ntime} '.v' ...
            num2str(nview) '.png']);
