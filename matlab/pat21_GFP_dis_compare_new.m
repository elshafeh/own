...
for ndata = 1:2
    ...
    for sb = 1:14
        ...
        if ndata == 2
            ...
            cfg                 = [];
            cfg.channel         = {'Fz', 'FC1', 'FCz', 'FC2', 'C1', 'Cz', 'C2', 'CP1', 'CPz', 'CP2'};
            cfg.avgoverchan     = 'yes';
            new_suj{sb,3}       = ft_selectdata(cfg,new_suj{sb,ndata});
...
lst_data = {'EEG GFP','MEG GFP','EEG FC'};

data2plot = [gavg{1}.avg;gavg{2}.avg(1,1:end-1)/10;gavg{3}.avg];
