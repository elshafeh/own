...
load ../data/stat/nback.multivar.avgstim.mat
...
for ncluster = 1:length(cluster_list)
    for ntest = 1:size(list_test,1)
        ...
        for nview = 1:length(list_view)
            ...
            fout = ['D:/Dropbox/project_me/figures_me/nback/post-kia/source/multivar/stim_av/test' num2str(ntest) '.' list_view_name{nview} '.png'];
            saveas(gcf,fout);
