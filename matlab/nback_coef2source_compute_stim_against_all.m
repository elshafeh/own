...
for ns = 1:length(list_suj)
    ...
    for nsession = 1:2
        ...
        for nstim = 1:10
            ...
            fname                       = ['J:/temp/nback/data/stim_ag_all/sub' num2str(list_suj(ns)) '.sess' num2str(nsession)  '.stim' num2str(nstim)  '.against.all.bsl.dwn70.coef.mat'];
            ...
            if exist(fname)
                ...
                fname_out             	= ['J:/temp/nback/data/stim_ag_all/sub' num2str(list_suj(ns)) '.sess' num2str(nsession)  '.stim' num2str(nstim)  '.against.all.bsl.dwn70.coef.lcmv.mat'];
                fprintf('saving %50s\n',fname_out);
                save(fname_out,'data');
