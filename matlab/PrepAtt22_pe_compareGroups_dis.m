...
for ngrp = 1:length(suj_group)
    ...
    for sb = 1:length(suj_list)
        ...
        suj                 = suj_list{sb};
        cond_main           = {'2DIS','2fDIS'};
        
        for dis_type = 1:2
            
            fname_in                            = ['/Volumes/hesham_megabup/pat22_fieldtrip_data/' suj '.' cond_main{dis_type} '.bpOrder2Filt0.5t20Hz.pe.mat'];
        ...
        cfg.parameter                       = 'avg';
        cfg.operation                       = 'x1-x2';
        allsuj_data{ngrp}{sb}               = ft_math(cfg,tmp{1},tmp{2}); clear tmp ;
