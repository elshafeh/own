...
for ngroup = 1:length(suj_group)
    ...
    for sb = 1:length(suj_list)
        ...
        for ncue = 1:length(list_ix)
            ...
            fname_in            = ['/Volumes/dycog/Aurelie/DATA/MEG/PAT_EXPE22/data/' suj '/field/' suj '.' list_ix_cue{ncue} '.DIS.broadAudSchTPJMniPF.1t110Hz.m200p800msCov.waveletPOW.25t120Hz.m200p600.MinEvokedAvgTrials.mat'];
            fprintf('Loading %s\n',fname_in);
            load(fname_in)
