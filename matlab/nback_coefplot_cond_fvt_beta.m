...
for nsuj  = 1:length(list_suj)
    ...
    list_cond                                   = {'decoding.1back.agaisnt.all.beta.peak.centered.lockedon.first', ...
        'decoding.2back.agaisnt.all.beta.peak.centered.lockedon.first', ...
        'decoding.1back.agaisnt.all.beta.peak.centered.lockedon.target',...
        'decoding.2back.agaisnt.all.beta.peak.centered.lockedon.target'};
    
    for ncond = 1:length(list_cond)
        
        sub_carr                              	= [];
        flist                                   = dir(['J:/nback/source/coef/sub' num2str(list_suj(nsuj)) '.' list_cond{ncond} ...
            '.dwn70.bsl.excl.coef.combinedlead.lcmv.mat']);
...
load ../data/stat/nback_cond_first_v_target_beta.mat
