...
[~,allsuj,~]    = xlsread('appariement_matlab_mig.xls','A:B');

suj_group{1}    = allsuj(1:19,1);
suj_group{2}    = allsuj(1:19,2);
...
writetable(behav_table,'PrepAtt22_behav_table4R_mig.csv','Delimiter',';')
