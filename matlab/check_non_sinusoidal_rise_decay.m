...
% - phase_window : width of time window (plus minus value)
...
function [ratios,time_to_decay_all,time_to_peak_all] = check_non_sinusoidal_rise_decay(virtsens,toi,phase,phase_window)
...
cfg.showcallinfo        = 'no';
cfg.bpfilter            = 'yes';
cfg.bpfreq              = [phase-phase_window phase+phase_window]; % Can be widened if necessary
