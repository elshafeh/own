...
for nsuj = 1:length(suj_list)
    ...
    for nback = [1 2]
        for nstim = [1 2]
            ...
            avg                     = [];
            avg.avg                 = squeeze(mean(freq.powspctrm(:,list_freq,:),2));
            ...
            list_cond{i}            = [list_stim{nstim} ' B' num2str(nback)];
...
list_chan                           = {'MEG0432+0433','MEG0442+0443','MEG0712+0713','MEG0722+0723','MEG0732+0733', ...
    'MEG0742+0743','MEG1132+1133','MEG1142+1143','MEG1342+1343','MEG1632+1633','MEG1812+1813','MEG1822+1823', ...
    'MEG1832+1833','MEG1842+1843','MEG1912+1913','MEG1942+1943','MEG2012+2013','MEG2022+2023','MEG2032+2033', ...
    'MEG2042+2043','MEG2212+2213','MEG2222+2223','MEG2232+2233','MEG2242+2243','MEG2312+2313','MEG2322+2323','MEG2412+2413','MEG2432+2433', 'MEG2442+2443'}
;
