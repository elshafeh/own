...
for nsuj = 1:length(suj_list)
    ...
    for nbehav = 1:2
        ...
        for nstim = [1 2 3 4 5 6 7 8 9]
            ...
            file_list         	= [file_list;dir(['~/Dropbox/project_me/data/nback/behav_timegen/sub' num2str(suj_list(nsuj)) '.' list_behav{nbehav} ...
                '.decoding.' ext_decode  num2str(nstim) '.nodemean.allstim.behbin.auc.timegen.mat'])];
