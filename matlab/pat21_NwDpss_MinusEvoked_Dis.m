...
for sb = 1:14
    ...
    for n_prt = 1:3
        ...
        nfilterout      = ['../data/filter/' suj '.pt' num2str(n_prt) '.DisfDis.' ext_filt_time '.' ext_filt_freq '.' ext_en_dur '.CommonFilter.mat'];
        ...
        for d = 1:2
            ...
            cfg                         = [];
            cfg.trials                  = h_chooseTrial(data_elan,0:2,1,1:4);
            ...
            for ntest = 1:length(tlist)
                ...
                ext_name = [suj '.pt' num2str(n_prt) '.' ext_lock{d} '.' ext_time '.' ext_freq '.' ext_en_dur '.source.mat'];
                fprintf('\nSaving %s\n',ext_name);
