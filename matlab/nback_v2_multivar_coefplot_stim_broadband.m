...
for ntest = 1:size(list_test,1)
    ...
    t1                  = find(round(time_axis,2) == round(0.7,2));
    t2                  = find(round(time_axis,2) == round(0.76,2));
