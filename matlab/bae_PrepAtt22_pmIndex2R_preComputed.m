...
for ngroup = 1:length(suj_group)
    ...
    for sb = 1:length(suj_list)
        ...
        ext_name1               = '1t20Hz';
        ext_name2               = 'broadAreas.1t20Hz.m800p2000msCov.waveletPOW.1t20Hz.m3000p3000.KeepTrials80SlctMinEvoked10MStep';
        ...
        for ncue = 1:length(list_ix)
            ...
            allsuj_data{ngroup}{sb,ncue}.label       = {'pmIndex'};
...
fOUT = '../documents/4R/BroadMan_AgeContrast_Alpha_pmIndex_p600p1100_7t15Hz_addFreqTime_MinEvoked_80Slct.txt';
fid  = fopen(fOUT,'W+');
