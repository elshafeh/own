...
cfg                     = [];
cfg.latency             = [0.5 1.2]; % latence du CNV
...
ix_test                 = [1 2]; %[1 2; 3 2; 4 2; 4 6; 3 5; 6 5; 4 3];
...
% save 'cluster_based_permutations_young_cue_meg_channels.mat'