...
for ns = 1:length(suj_list)
    ...
    list_cond                                   = {'color','frequency','orientation'};
    
    time_width                                  = 0.05;
    time_list                                   = -1:time_width:1; % -1:time_width:6.5;
    ...
    for ncond = 1:length(list_cond)
        ...
        for nfreq = 1:length(freq_list)
            fname                               = ['J:/temp/bil/grating_mtm_auc/' subjectName '.decodegrating.' list_cond{ncond} '.' ...
