...
load ../data/stat_data/dis1_freq_spec_sensor_thetabetalpha.mat
...
% plimit                                      = 0.05;
% stat2plot                                   = h_plotStat(stat{1,1},0.000000000000000000000000000001,0.1);
% zlimit                                      = 1;
% nwS2plot                                    = stat2plot;
% 
% cfg                                         = [];
...
list_freq       = [8 14; 20 30; 3 7];
list_time       = [0.3 0.6; 0.3 0.5;0 0.4];
