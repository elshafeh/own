...
for f = 1:2
    ...
    for t = 1:20
        ...
        for sb = 1:14
            ...
            for unf = 1:2 
                nw_avg{sb,unf}      = source_avg{sb,1} ;
                nw_avg{sb,unf}.pow  = source_avg{sb,unf}.pow - source_avg{sb,3}.pow;  
            end
            
        end
        
        source_avg = nw_avg ; clear nw_avg
        ...
        if min_p < p_lim
            ...
            fname = [cnd_freq{f} '.' num2str(round(cnd_time(t),1)*1000)];
