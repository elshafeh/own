...
for nsuj  = 1:length(list_suj)
    ...
    list_cond                                   = {'beta.peak.centered.1back.isfirst','beta.peak.centered.2back.isfirst', ...
...
load ../data/stat/nback_stim_category_first_v_target_beta.mat

%%
close all
zlist                       = [0.005 0.01 0.01 0.01];
list_test                   = [3 1; 4 1; 3 2; 4 2];
cluster_list                = {[1]};
