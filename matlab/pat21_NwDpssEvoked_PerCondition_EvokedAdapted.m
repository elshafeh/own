...
for sb = 1:14
    ...
    for ext_lock    = {'CnD'};
        ...
        for n_prt = 1:3
            ...
            data_all        = data_elan ; clear data_elan;
            ...
            for ncue = 1:length(lst_cnd_cue)
                ...
                cfg         = [];
                cfg.trials  = h_chooseTrial(data_all,ncue-1,0:3,1:4); % Here is where you choose the trials !!!
                data_elan   = ft_selectdata(cfg,data_all);
                ...
                for ntest = 1:length(tlist)
                    ...
                    ext_dur  = 'MinusAdaptedEvokedHanning.source';
            ...
            clear leadfield com_filter data_all
