...
for nsuj = 1:length(suj_list)
    ...
    for ncond = 1:length(list_cond)
        ...
        list_lock                   = {'all.d','target.d','nonrand.d','first.d'};
        pow                         = [];
    ...
    alldata{nsuj,ncond+1}.powspctrm(:)   	= 0.5;
...
% save('../data/stat/nback.cond.ag.all.contrast.mtm.mat','stat','list_test','list_test_name');
