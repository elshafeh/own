...
fOUT = '../documents/4R/AudioVisualbroadman_AllYoung_IAF_AllTrials_withCueConditions_AllTrials.txt';
fid  = fopen(fOUT,'W+');
...
for ngroup = 1:length(list_group)
    ...
    for sb = 1:length(suj_list)
        ...
        ext_name1               = '1t20Hz';
        ext_name2               = 'NewAVBroad.1t20Hz.m800p2000msCov.waveletPOW.1t19Hz.m3000p3000.KeepTrialsMinEvoked10MStep100SlctSorted';
