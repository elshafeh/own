...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [MI_matrix_raw,MI_matrix_surr,MI_raw_surr] = separate_calc_MI_optimised(original_virtsens_pha,original_virtsens_amp,list_toi,phase,amp,diag,surrogates,list_approach,step_phase,step_amp,chan_index,trial_index,varargin)
