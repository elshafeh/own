function [s, cfg] = ft_statfun_correlationT_FisherZ(cfg, dat, design)
...
%
% $Id: ft_statfun_correlationT.m 10837 2015-10-30 16:06:41Z arjsto $
...
if strcmp(cfg.computestat,'yes') % compute the statistic    
    ...
    rho = corr(dat', design', 'type', cfg.type);
     ...
     % here's what I added : H.ElShafei
