function data_elan = com_fun_eeg2field_cue(suj,time_pre,time_post,lock)

elan_file                   = ['F:/Fieldtripping/data/eeg/' suj '.pat2.fin.eeg.eeg'];
pos_orig                    = load(['F:/Fieldtripping/data/pos/' suj '.pat2.fin.pos']);
...
if strcmp(suj,'yc13')
    Ds_Name                 = ['F:/Fieldtripping/data/ds/' suj '.pat2.b2.ds'];
else
    Ds_Name                 = ['F:/Fieldtripping/data/ds/' suj '.pat2.b1.ds'];
end
