function index_trials = nbk_trialinfo2rtindex(trialinfo,f_focus)
...
for nback = [1 2]
    ...
    %median split
    index_trials{nback,1}    	= sub_info_correct(sub_info_correct(:,2) < median_rt,3); % fast
    index_trials{nback,2}       = sub_info_correct(sub_info_correct(:,2) > median_rt,3); % slow
