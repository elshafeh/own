...
for (nvar in c(1,2)){
  ...
  # model_beh           <- lme4::lmer(var ~ (eye) + (1|suj), data =rep_data)
  ...
  pplot <- ggplot(rep_data, aes(x = eye, y = var, fill = eye)) +
...
ggsave(filename="/Users/heshamelshafei/Dropbox/project_me/presentations/eyes2021/svg/eyes_behavrainclouds.SVG",
