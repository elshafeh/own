...
lsmeans::cld(lsmeans::lsmeans(sub_model.pat,  "CUE_POSITION"),details= TRUE)
lsmeans::cld(lsmeans::lsmeans(sub_model.pat,  "HEMI"),details= TRUE)
lsmeans::cld(lsmeans::lsmeans(sub_model.pat,  pairwise~CUE_POSITION|HEMI),details= TRUE)
...
lsmeans::cld(lsmeans::lsmeans(sub_model.pat,  "FREQ"),details= TRUE)
