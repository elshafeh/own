...
rm(list=ls())
fname = "/Users/heshamelshafei/Google Drive/PhD/Fieldtripping/R/txt/PrepAtt22_YoungParticipants_behav_table4R_with.NLR.Tukey.csv"
...
group_anova <- ezANOVA(pat_age,dv=.(MedianRTukey),wid = .(SUB),within = .(CUE,DIS),detailed=T)
print(group_anova)
...
interaction.plot(pat_age$DIS, pat_age$CUE,
                 ...
                 col=c(4,2,5),lwd = 4, lty = 1, ylim=c(0,10),legend = TRUE,xlab="Distractor", ylab="PerFlaseAlarm")