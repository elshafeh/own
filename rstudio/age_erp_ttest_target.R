...
sub_pat     <- pat[pat$CHANNEL=="Cz.10" & pat$TIME=="1p70p150",c("GROUP","AVG")]
res         <- t.test(sub_pat[sub_pat$GROUP=='Old',"AVG"], sub_pat[sub_pat$GROUP=='Young',"AVG"])
res$p.value * 18
cohen.d(sub_pat,"GROUP",alpha=.05)

sub_pat     <- pat[pat$CHANNEL=="Pz.5" & pat$TIME=="2p250p400",c("GROUP","AVG")]
res         <- t.test(sub_pat[sub_pat$GROUP=='Old',"AVG"], sub_pat[sub_pat$GROUP=='Young',"AVG"])
res$p.value * 18
cohen.d(sub_pat,"GROUP",alpha=.05)

sub_pat     <- pat[pat$CHANNEL=="gmfp" & pat$TIME=="1p70p150",c("GROUP","AVG")]
res         <- t.test(sub_pat[sub_pat$GROUP=='Old',"AVG"], sub_pat[sub_pat$GROUP=='Young',"AVG"])
res$p.value * 18
cohen.d(sub_pat,"GROUP",alpha=.05)

sub_pat     <- pat[pat$CHANNEL=="gmfp" & pat$TIME=="2p250p400",c("GROUP","AVG")]
res         <- t.test(sub_pat[sub_pat$GROUP=='Old',"AVG"], sub_pat[sub_pat$GROUP=='Young',"AVG"])
res$p.value * 18
cohen.d(sub_pat,"GROUP",alpha=.05)
