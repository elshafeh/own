...
#HEADER
scenario = "Detection_threshold_r";
...
picture{
text { caption = "PAUSE ... Tirez le joystick pour continuer"; };
x=0;
y=0;};
time=0;
}trial_pause;

bitmap{filename = "instr123edit.bmp";}pt;
...
filename.append("C:/Users/Administrateur/Desktop/users/AURELIE/PAT/PrepAtt_Path/PrepAtt_Path_14nov2011/log/");
filename.append(nom_sujet);
filename.append("_Disc_Threshold_result.txt");
