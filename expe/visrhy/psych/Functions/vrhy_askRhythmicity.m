function vrhy_askRhythmicity
% Ask about rhythmicity
global Info scr wPtr

vrhy_darkenBackground;
text = 'Please rate the rhythmiticy you perceived in this block';
...
if IsLinux
    ...
    Info.blocks.rhythmicity = [Info.blocks.rhythmicity, repButton];
    scr.b.clearResponses;
else
    vrhy_response_wait;
end
