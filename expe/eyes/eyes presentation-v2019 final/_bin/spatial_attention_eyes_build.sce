# header
scenario = "spatial attention build";
...
TEMPLATE "audcue_tactstimEX5.tem" {          
...
# block - NO DISTRACTOR
TEMPLATE "audcue_tactstimPR5.tem"  randomize {          
cue		cue_code 	stim		resp; 
LOOP $i 2; # 2*4 = 8 trials (4 blocks)
cue_left  	64			 2 		 1; # cue left   stim left	 	low
cue_left  	64			 2 		 2; # cue left   stim left	 	high
cue_right 	128		 1 		 1; # cue right  stim right 	low
cue_right 	128		 1 		 2; # cue right  stim right 	high
ENDLOOP;
};
