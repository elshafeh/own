...
int dur_cue=200;					#cue presentation 192 (to be changed in Template "PrepAtt_stim_trial.tem" to 200 for trials = 12 trames a 60Hz  (# sd 194)
...
filename.append(nom_sujet);
filename.append("_");
filename.append("Disc_Fix"); #discrimination 
filename.append("_");
filename.append(num_bloc);
filename.append(".txt");
...
# Output for the matlab code: low_L(A) high_L (B) high_R (C) low_R (D) Blank (E)
   ...
   event_dis.set_deltat(dur_cue+delay1+delay_plus1);
