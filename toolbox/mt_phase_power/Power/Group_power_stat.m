...
for pnum=1:size(Names_Test,2)
   ...
   load(fullfile(File_st.power_files_path,[Analysis '_' Names_Test{pnum} '_' Power_st.output_file '.mat']));
...
save(fullfile(File_st.power_files_path,[Analysis '_' Power_st.stats_output_file '.mat']),'group_power_stat');
