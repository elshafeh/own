...
suj_list                                                                    = [12,13,14,15,16,17]
data_list                                                                   = list(['CnD.com90roi.eeg','CnD.com90roi.meg'])
...
for isub in range(len(suj_list)):
    for idata in range(len(data_list)):
        ...
        dir_in                                                              = '/project/3015039.05/temp/meeg/data/lcmv_mtm/' + suj + '/'
        dir_out                                                             = '/project/3015039.05/temp/meeg/data/auc/' + suj + '/'
        
        # Make new director for output data
        if not os.path.exists(dir_out):
            os.mkdir(dir_out)
        
        for ifreq in range(1,21):
            ...
            if os.path.exists(fname):
                ...
                for ifeat in range(len(feat_list)):
                    ...
                    fname_out                                               =  dir_out + suj + '.' + data_list[idata] + '.' + feat_list[ifeat] + '.' + str(ifreq) + 'Hz.aucbychan.mat'
