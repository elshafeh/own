...
for isub in range(len(suj_list)):
    for idata in range(len(data_list)):
        ...
        fname                                               = '/Users/heshamelshafei/Desktop/data/'
        fname                                               = fname + suj + '.' + data_list[idata] + '.latindex.mat'
        ...
        for ifeat in range(len(feat_list)):
            ...
            fname_out   =  '/Users/heshamelshafei/Desktop/lat/' 
            fname_out   =  fname_out+ suj + '.' + data_list[idata] + '.' + feat_list[ifeat] + '.latindex.auc.mat'
