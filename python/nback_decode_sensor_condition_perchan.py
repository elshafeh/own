...
for isub in range(len(suj_list)):
    for ifreq in range(len(frq_list)):
        ...
        suj                                                 = suj_list[isub]
        fname                                               = dir_data + 'sub' + str(suj) + '.sensor.bslcorr.' + str(frq_list[ifreq]) + 'Hz.mat'
        ...
        if os.path.isfile(fname):
            ...
            for xi in range(len(test_name)):
                ...
                dir_out                                     = big_dir + 'decode/auc_freq_break/'
                fname_out                                   =  dir_out + 'sub' + str(suj) + '.' + test_name[xi]  + '.' + str(frq_list[ifreq]) + '.auc.bychan.mat'
