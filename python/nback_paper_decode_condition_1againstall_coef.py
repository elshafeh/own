# -*- coding: utf-8 -*-
"""
Created on Fri Feb 14 15:24:55 2020
...
for isub in range(len(suj_list)):
    ...
    for nstim in [2]:
        ...
        for nback in [0,1,2]:
            ...
            dir_out                                     = 'J:/temp/nback/data/sens_level_auc/coef/'
            fscores_out                                 = dir_out + 'sub' + str(suj) + '.decoding.' + str(nback) + 'back.'
            fscores_out                                 = fscores_out+ 'agaisnt.all.lockedon.' +list_stim[nstim-1]+ '.dwn70.bsl.excl.coef.mat'
