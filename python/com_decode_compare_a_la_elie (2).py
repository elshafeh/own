...
data_list                                                   = list(['pt1.CnD.meg','pt2.CnD.meg','pt3.CnD.meg'])
#data_list                                                   = list(['CnD.eeg'])
...
for idata in range(len(data_list)):
    for isub in range(len(suj_list)):
        ...
        fname                                               = '/project/3015079.01/temp/meeg/data/preproc_data/' + suj + '.' + data_list[idata] + '.sngl.dwn100.lp30.mat'
        ...
        for ifeat in range(len(feat_list)):
            ...
            print('\nExtracting coefficients for '+ fname)
            ...
            fname_out   =  '/project/3015079.01/temp/meeg/data/coef/' + suj + '.' + data_list[idata] + '.' + feat_list[ifeat] + '.lp30.coef.mat'
