...
savename                                    = dir_data_out + 'sub' + str(suj) + '.decoding.condition.' + ext_demean + '.leaveone.mat'
...
if not os.path.exists(savename):
    for ich in range(n_times):
        ...
        for train, test in loo.split(X_c_p):     
            ...
            #TEST
            print('sub' + str(suj) + ' decoding cond ' +str(ich+1) + '/' + str(n_times) + ' timepoint, ' + str(test+1) +'/' + str(n_trials) + ' trial')
