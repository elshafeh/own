# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 14:30:00 2020
...
for isub in range(len(suj_list)):
    for ifreq in range(len(freq_list)):
        ...
        for nback in [0,1,2]:
            ...
            #fscores_out                                         = dir_out + 'sub' + str(suj) + '.decoding.rt.' + str(nback) + 'back.' + freq_list[ifreq] + '.bsl.auc.mat'
            fcoef_out                                           = dir_out + 'sub' + str(suj) + '.decoding.rt.' + str(nback) + 'back.' + freq_list[ifreq] + '.bsl.coef.mat'         
