...
for isub in range(len(suj_list)):
    ...
    wind_list                                   = list(["preCue1","preCue2","preGab1","preGab2"])
        ...
        for iwind in range(len(wind_list)):
            ...
            for ibin in [0,4]:
                ...
                for ifeat in [1]:
                    ...
                    fname_out                   = dir_data_out + suj + '.cuebroad.decodingrep.' +freq_list[ifreq] + '.band.'
                    fname_out                   = fname_out +wind_list[iwind] + '.window.bin' + str(ibin+1) + '.' + dcd_list[ifeat] + '.all.bsl.auc.mat'
