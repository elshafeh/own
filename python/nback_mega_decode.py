...
for isub in range(len(suj_list)):
    for ifreq in range(1,31):
        for ises in [0,1]:
            ...
            fname                                                           = 'P:/3015079.01/nback/vox_tf/sub' + str(suj)+ '.sess' +str(ises+1) + '.voxbrain.' + str(ifreq)+ 'Hz.mat'  
            ename                                                           = 'P:/3015079.01/nback/vox_tf/sub' + str(suj)+ '.sess' +str(ises+1) + '.trialinfo.mat'
