...
dir_data                                                                = '/Users/heshamelshafei/Dropbox/project_me/nback/data/prepro/no_rep/'
        ...
        for nback in range(3):
            ...
            for stim_lock in range(0,3):
                ...
                for xi in range(1,11):
                    ...
                    dir_out                                             = '/Users/heshamelshafei/Dropbox/project_me/nback/data/decode_data/stim_stack/'
                    fname_out                                           = dir_out + 'sub' + str(suj) + '.stim' + str(xi) + '.' + str(nback) + 'back.'+ str(stim_lock)
                    fname_out                                           = fname_out + 'lock.3cv.auc.collapse.mat'
